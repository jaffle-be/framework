                                ...
                                <ul class="dropdown-menu">
                                    <li class="dropdown-submenu active">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li><a href="header_v6_semi_dark_transparent.blade.php">Header v6 Dark Transparent</a></li>
                                            <li><a href="header_v6_semi_white_transparent.blade.php">Header v6 White Transparent</a></li>
                                            ...
                                            <li class="active"><a href="header_v6_dark_dropdown.blade.php">Header v6 Dark Dropdown</a></li>
