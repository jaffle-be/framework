                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="dropdown-submenu">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a target="_blank" href="Shop-UI/shop-ui-add-to-cart.html">- Checkout Page</a>
                                    </li>
                                    <li><a target="_blank" href="Shop-UI/shop-ui-login.html">- Login Page</a></li>
                                    <li><a target="_blank" href="Shop-UI/shop-ui-register.html">- Registration Page</a>
                                    </li>
                                </ul>
                            </li>
                            <!-- End Shop UI -->
                    ...
                    <li class="dropdown active">
                        ...
                        <ul class="dropdown-menu">
                            <li class="dropdown-submenu active">
                                ...
                                <ul class="dropdown-menu">
                                    <li class="active"><a href="header_default.blade.php">Header Default</a></li>
                                    ...
                                    <li><a href="header_v6_dark_res_nav.blade.php">Header v6 Dark in Responsive</a></li>
                                </ul>
                            </li>
                            <li class="dropdown-submenu">
