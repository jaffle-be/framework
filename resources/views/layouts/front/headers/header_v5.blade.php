                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="dropdown-submenu">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a href="page_search_inner_full_width.html">Search Results Full Width</a>
                                        </li>
                                        <li><a href="page_search_inner_left_sidebar.html">Search Result Left Sidebar</a>
                                        </li>
                            ...
                            <ul class="dropdown-menu">
                                <li class="dropdown-submenu active">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li class="active"><a href="header_v5.blade.php">Header v5</a></li>
                                        ...
                                        <li><a href="header_v6_border_bottom.blade.php">Header v6 Border Bottom</a></li>
                                        <li><a href="header_v6_classic_dark.blade.php">Header v6 Classic Dark</a></li>
                                        <li><a href="header_v6_classic_white.blade.php">Header v6 Classic White</a></li>
                                        <li><a href="header_v6_dark_dropdown.blade.php">Header v6 Dark Dropdown</a></li>
                                        <li><a href="header_v6_dark_scroll.blade.php">Header v6 Dark on Scroll</a></li>
                                        <li><a href="header_v6_dark_search.blade.php">Header v6 Dark Search</a></li>
                                        <li><a href="header_v6_dark_res_nav.blade.php">Header v6 Dark in Responsive</a>
                                        </li>
                                    </ul>
                                </li>
                                <li class="dropdown-submenu">
                                ...
                                <li>
                                    <div class="mega-menu-content disable-icons">
                                        <div class="container">
                                            <div class="row">
                                                <div class="col-md-3">
                                                    <h3 class="mega-menu-heading">Typography</h3>
                                                ...
                                                <div class="col-md-3">
                                                    <h3 class="mega-menu-heading">Buttons &amp; Icons</h3>
                                                    <ul class="list-unstyled style-list">
                                                        <!-- Buttons -->
                                                        <li>
                                                ...
                                                <div class="col-md-3">
                                                    <h3 class="mega-menu-heading">Common elements</h3>
                                                    <ul class="list-unstyled style-list">
                                                        <!-- Content Boxes -->
                                                        <li>
                                                ...
                                                <div class="col-md-3">
                                                    <h3 class="mega-menu-heading">Forms &amp; Infographics</h3>
                                                    <ul class="list-unstyled style-list">
                                                        <!-- Forms -->
                                                        <li>
