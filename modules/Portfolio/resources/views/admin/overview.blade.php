<div class="row wrapper wrapper-content portfolio-overview" ng-controller="PortfolioController as vm" ng-cloak>
    ...
    <div class="ibox" st-table="vm.projects" st-pipe="vm.list">
        ...
        <div class="ibox-content">
            ...
            <table class="table table-hover table-striped table-responsive vertical" ng-show="vm.projects">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-3">
                                <div class="dropdown" data-api="dropdown">
                                    <a class="btn btn-default dropdown-toggle" data-toggle="dropdown"
                                       href="#">{{ Lang::get('portfolio::admin.actions.actions') }}&nbsp;<span
                                            class="caret">&nbsp;</span></a>
                                    <ul class="dropdown-menu">
                                        <li>
                                            <a select-all="vm.projects"
                                               href="">{{ Lang::get('portfolio::admin.actions.select_all') }}</a>
                                        </li>
                                        <li>
                                            <a select-none="vm.projects" data-trigger="select-none"
                                               href="">{{ Lang::get('portfolio::admin.actions.select_none') }}</a>
                                        </li>
                                        <li class="divider"></li>
                                        <li>
                                            <a ng-confirm="vm.batchPublish()"
                                               href="">{{ Lang::get('portfolio::admin.actions.publish') }}</a>
                                        </li>
                                        <li>
                                            <a ng-confirm="vm.batchUnpublish()"
                                               href="">{{ Lang::get('portfolio::admin.actions.unpublish') }}</a>
                                        </li>
                                        <li class="divider"></li>
                                        <li>
                                            <a ng-really="vm.delete()"
                                               href="">{{ Lang::get('portfolio::admin.actions.remove') }}</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div class="col-xs-3">
                                <a class="btn btn-sm btn-primary pull-right"
                                   ng-click="vm.newProject()">{{ Lang::get('portfolio::admin.project.new-project') }}</a>
                            </div>
                ...
                <tr>
                    <td class="text-center" st-pagination st-items-by-page="vm.rpp" colspan="7"
                        st-change="vm.list"></td>
                </tr>
                <tr ng-repeat="project in vm.projects" ui-sref="admin.portfolio.detail({id: project.id})"
                    ...
                    <td width="60%">
                        <div class="">
                            <img class="pull-left img-responsive img-rounded"
                                 ng-src="@{{ project.images[0].sizes[0].path }}"/>
                            <h4 ng-bind-html="renderHtml(project.translations[vm.options.locale].title)"></h4>
                            <span
                                ng-bind-html="renderHtml(project.translations[vm.options.locale].cached_extract)"></span>
                        </div>
