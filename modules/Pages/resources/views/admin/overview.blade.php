<div class="row wrapper wrapper-content" ng-controller="PagesController as vm" ng-init="vm.options = {{ system_options() }}" ng-cloak>
            ...
            <table class="table table-hover table-striped table-responsive vertical" ng-show="vm.pages">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-3">
                                <div class="dropdown" data-api="dropdown">
                                    <a class="btn btn-default dropdown-toggle" data-toggle="dropdown" href="#">{{ Lang::get('pages::admin.actions.actions') }}&nbsp;<span class="caret">&nbsp;</span></a>
                                    <ul class="dropdown-menu">
                                        <li>
                                            <a select-all="vm.pages" href="">{{ Lang::get('pages::admin.actions.select-all') }}</a>
                                        </li>
                                        <li>
                                            <a select-none="vm.pages" href="">{{ Lang::get('pages::admin.actions.select-none') }}</a>
                                        </li>
                                        <li class="divider"></li>
                                        <li>
                            ...
                            <div class="col-xs-3">
                                <a class="btn btn-sm btn-primary pull-right" ng-click="vm.newPage()">{{ Lang::get('pages::admin.page.create') }}</a>
                            </div>
                ...
                <tr ng-repeat="page in vm.pages" ui-sref="admin.pages.page({id: page.id})" class="pages-page-overview">
                    <td width="10%" ng-click="$event.stopPropagation()">
                        <input type="checkbox" class="filled-in" id="row@{{ $index + 1 }}" ng-checked="page.isSelected"/>
                        <label for="row@{{ $index + 1 }}">@{{ $index + 1 }}</label>
                    </td>
                    <td width="0%">&nbsp;</td>
                    <td>
                        <div class="">
                            <img class="pull-left img-responsive img-rounded" ng-src="@{{ page.images[0].sizes[0].path }}"/>
                            <h4 ng-bind-html="renderHtml(page.translations[vm.options.locale].title)"></h4>
                            <span ng-bind-html="renderHtml(page.translations[vm.options.locale].extract)"></span>
                        </div>
                    </td>
