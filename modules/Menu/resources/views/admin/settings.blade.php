            ...
            <div class="ibox">
                ...
                <div class="ibox-tabs">
                    ...
                    <uib-tabset>
                        ...
                        <uib-tab ng-repeat="menu in vm.menus" heading="@{{ menu.name }}"
                                 select="vm.selectMenu(menu)"></uib-tab>
                    ...
                    <div class="ibox-content ibox-with-footer">
                        ...
                        <ul class="menu-items" data-as-sortable="vm.sortables" data-ng-model="vm.menu.items">
                            ...
                            <li ng-repeat="item in vm.menu.items" as-sortable-item
                                ng-class="{active: vm.item.id == item.id}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-6">
                                    <button class="btn btn-primary"
                                            ng-click="vm.newItem()">{{ Lang::get('menu::admin.new-item') }}</button>
                                </div>
                                <div class="col-xs-6">
                                    <button class="pull-right btn btn-danger" ng-really="vm.deleteMenu()"
                                            title="{{ Lang::get('menu::admin.delete-menu') }}">
            ...
            <div class="ibox">
                ...
                <div class="ibox-tabs">
                    ...
                    <uib-tabset>
                        ...
                        <uib-tab heading="{{ Lang::get('menu::admin.manual-item') }}" active="vm.tabs['manual']"
                                 select="vm.selectTab('manual')">
                            @include('menu::admin.manual-item')
                        </uib-tab>

                        <uib-tab heading="{{ Lang::get('menu::admin.page-item') }}" active="vm.tabs['page']"
                                 select="vm.selectTab('page')">
                            @include('menu::admin.page-item')
                        </uib-tab>

                        <uib-tab heading="{{ Lang::get('menu::admin.linkable-route') }}" active="vm.tabs['route']"
                                 select="vm.selectTab('route')">
