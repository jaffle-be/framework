                                                            ...
                                                            <tr>
                                                                <td align="center" valign="top" style="padding:5px;">
                                                                    <table border="0" cellpadding="0" cellspacing="0"
                                                                        ...
                                                                        <tr>
                                                                            <td align="center" valign="top"
                                                                                class="emailCalendarMonth">
                                                                                September
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td align="center" valign="top"
                                                                                class="emailCalendarDay">
                                                                                16
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                            ...
                                            <table align="Left" border="0" cellpadding="0" cellspacing="0" width="320"
                                                ...
                                                <tr>
                                                    <td valign="top" class="textContent">
                                                        <h3>Left Column</h3>
                                                        <br>
                                                        A kitten or kitty is a juvenile domesticated cat. Kittens are
                                                        highly social animals and spend most of their waking hours
                                                        playing and interacting with available companions.
                                                    </td>
                                                </tr>
                                            </table>
                                            <!-- // CONTENT TABLE -->
