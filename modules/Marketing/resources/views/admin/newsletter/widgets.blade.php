        ...
        <uib-tabset justified="true">
            ...
            <uib-tab heading="{{ Lang::get('marketing::admin.widgets') }}" active="vm.pageTabs[0]">
                ...
                <div class="ibox-tabs">
                    ...
                    <uib-tabset justified="true">
                        <uib-tab heading="{{ Lang::get('marketing::admin.one-per-row') }}" active="vm.widgetTabs[0]"
                                 select="vm.itemsPerRow = 1">
                        </uib-tab>
                        <uib-tab heading="{{ Lang::get('marketing::admin.two-per-row') }}" active="vm.widgetTabs[1]"
                                 select="vm.itemsPerRow = 2">
                        </uib-tab>
                    </uib-tabset>
                ...
                <div class="ibox-content">
                    <div ng-repeat="widget in vm.campaign.availableWidgets"
                         ng-include="'widgets/newsletter/placeholders/' + widget.name"
                         ng-show="vm.itemsPerRow == widget.items"></div>
                </div>
            ...
            <uib-tab heading="{{ Lang::get('marketing::admin.images') }}" active="vm.pageTabs[1]">
                ...
                <div class="ibox-content">
                    <image-input owner-type="'newsletter'" owner-id="$state.params.id" locale="vm.options.locale"
                                 images="vm.campaign.images"></image-input>
                </div>
