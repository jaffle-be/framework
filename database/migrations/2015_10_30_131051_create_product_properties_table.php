...
//        });
//
//        Schema::create('product_property_groups_translations', function (Blueprint $table) {
//            $table->increments('id');
//            $table->integer('group_id', false, true);
//            $table->foreign('group_id', 'translation_to_product_property_group')->references('id')->on('product_property_groups')->onDelete('cascade');
