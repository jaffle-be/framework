...
class CreateAccountContactInformationTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('account_contact_information', function (Blueprint $table) {
            ...
            $table->foreign('account_id', 'account_contact_information_to_account')->references('id')->on('accounts');
            $table->string('email');
            $table->string('phone');
            $table->string('vat');
        ...
        Schema::create('account_contact_information_translations', function (Blueprint $table) {
            ...
            $table->foreign('account_contact_information_id', 'translation_to_account_contact_information')->references('id')->on('account_contact_information');
            $table->timestamps();
        });
    }
