<nav class="navbar-default navbar-static-side" role="navigation">
    <div class="sidebar-collapse">
        <ul side-navigation class="nav" id="side-menu">
            ...
            <li ui-sref-active="active">
                <a ui-sref="admin.portfolio.overview"><i class="fa fa-newspaper-o"></i> <span class="nav-label">@{{ 'PORTFOLIO' | translate }}</span></a>
            </li>
            ...
            <li ng-class="{active: $state.includes('admin.theme')}">
                ...
                <ul class="nav nav-second-level" ng-class="{in: $state.includes('admin.theme')}">
                    ...
                    <li ui-sref-active="active">
                        <a ui-sref="admin.theme.settings"><i class="class fa fa-gear"></i> <span class="nav-label">@{{ 'SETTINGS' | translate }}</span></a>
                    </li>
