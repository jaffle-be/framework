<div class="container content">
    ...
    <ul class="list-inline owl-slider-v2">
        <li class="item first-child">
            <img src="{{ asset('/assets/img/clients/07.png') }}" alt="">
        </li>
        <li class="item">
            <img src="{{ asset('/assets/img/clients/08.png') }}" alt="">
        </li>
        <li class="item">
            <img src="{{ asset('/assets/img/clients/10.png') }}" alt="">
        </li>
        <li class="item">
            <img src="{{ asset('/assets/img/clients/11.png') }}" alt="">
        </li>
        <li class="item">
            <img src="{{ asset('/assets/img/clients/09.png') }}" alt="">
        </li>
        <li class="item">
            <img src="{{ asset('/assets/img/clients/12.png') }}" alt="">
        </li>
        <li class="item">
            <img src="{{ asset('/assets/img/clients/07.png') }}" alt="">
        </li>
