<div class="container">
    ...
    <div class="illustration-v2 margin-bottom-60">
        ...
        <ul class="list-inline owl-slider-v4">
            <li class="item">
                <a href="#"><img class="img-responsive" src="{{ asset('/assets/img/thumb/09.jpg') }}" alt=""></a>
            ...
            <li class="item">
                <a href="#"><img class="img-responsive" src="{{ asset('/assets/img/thumb/07.jpg') }}" alt=""></a>
                <div class="product-description-v2">
                    <div class="margin-bottom-5">
                        <h4 class="title-price"><a href="#">Double-breasted</a></h4>
            ...
            <li class="item">
                <a href="#"><img class="img-responsive" src="{{ asset('/assets/img/thumb/08.jpg') }}" alt=""></a>
                <div class="product-description-v2">
                    <div class="margin-bottom-5">
                        <h4 class="title-price"><a href="#">Double-breasted</a></h4>
                        <span class="title-price">$95.00</span>
            ...
            <li class="item">
                <a href="#"><img class="img-responsive" src="{{ asset('/assets/img/thumb/06.jpg') }}" alt=""></a>
                <div class="product-description-v2">
                    <div class="margin-bottom-5">
                        <h4 class="title-price"><a href="#">Double-breasted</a></h4>
                        <span class="title-price">$95.00</span>
            ...
            <li class="item">
                <a href="#"><img class="img-responsive" src="{{ asset('/assets/img/thumb/04.jpg') }}" alt=""></a>
                <div class="product-description-v2">
                    <div class="margin-bottom-5">
                        <h4 class="title-price"><a href="#">Double-breasted</a></h4>
                        <span class="title-price">$95.00</span>
            ...
            <li class="item">
                <a href="#"><img class="img-responsive" src="{{ asset('/assets/img/thumb/03.jpg') }}" alt=""></a>
                <div class="product-description-v2">
                    <div class="margin-bottom-5">
                        <h4 class="title-price"><a href="#">Double-breasted</a></h4>
                        <span class="title-price">$95.00</span>
