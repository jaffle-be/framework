                            ...
                            <table class="table table-striped">
                                ...
                                <tr>
                                    <td class="product-in-table">
                                        <img class="img-responsive" src="{{ asset('/assets/img/thumb/08.jpg') }}" alt="">
                                ...
                                <tr>
                                    <td class="product-in-table">
                                        <img class="img-responsive" src="{{ asset('/assets/img/thumb/07.jpg') }}" alt="">
                                ...
                                <tr>
                                    <td class="product-in-table">
                                        <img class="img-responsive" src="{{ asset('/assets/img/thumb/06.jpg') }}" alt="">
                                ...
                                <tr>
                                    <td class="product-in-table">
                                        <img class="img-responsive" src="{{ asset('/assets/img/thumb/09.jpg') }}" alt="">
...
@section('scripts-plugins')
    @parent
    <script src="{{ asset('/assets/plugins/jquery-steps/build/jquery.steps.js') }}"></script>
...
@section('scripts-app')
    ...
    <script src="{{ asset('/assets/js/forms/shop/login.js') }}"></script>
    <script src="{{ asset('/assets/js/plugins/stepWizard.js') }}"></script>
