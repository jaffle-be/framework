            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    ...
                    <ul class="list-inline blog-photostream margin-bottom-50">
                        <li>
                            <a href="{{ asset('/assets/img/main/img22.jpg') }}" rel="gallery" class="fancybox img-hover-v2" title="Image 1">
                                <span><img class="img-responsive" src="{{ asset('/assets/img/main/img22.jpg') }}" alt=""></span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ asset('/assets/img/main/img23.jpg') }}" rel="gallery" class="fancybox img-hover-v2" title="Image 2">
                                <span><img class="img-responsive" src="{{ asset('/assets/img/main/img23.jpg') }}" alt=""></span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ asset('/assets/img/main/img4.jpg') }}" rel="gallery" class="fancybox img-hover-v2" title="Image 3">
                                <span><img class="img-responsive" src="{{ asset('/assets/img/main/img4.jpg') }}" alt=""></span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ asset('/assets/img/main/img9.jpg') }}" rel="gallery" class="fancybox img-hover-v2" title="Image 4">
                                <span><img class="img-responsive" src="{{ asset('/assets/img/main/img9.jpg') }}" alt=""></span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ asset('/assets/img/main/img25.jpg') }}" rel="gallery" class="fancybox img-hover-v2" title="Image 5">
                                <span><img class="img-responsive" src="{{ asset('/assets/img/main/img25.jpg') }}" alt=""></span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ asset('/assets/img/main/img6.jpg') }}" rel="gallery" class="fancybox img-hover-v2" title="Image 6">
                                <span><img class="img-responsive" src="{{ asset('/assets/img/main/img6.jpg') }}" alt=""></span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ asset('/assets/img/main/img20.jpg') }}" rel="gallery" class="fancybox img-hover-v2" title="Image 7">
                                <span><img class="img-responsive" src="{{ asset('/assets/img/main/img20.jpg') }}" alt=""></span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ asset('/assets/img/main/img3.jpg') }}" rel="gallery" class="fancybox img-hover-v2" title="Image 8">
                                <span><img class="img-responsive" src="{{ asset('/assets/img/main/img3.jpg') }}" alt=""></span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ asset('/assets/img/main/img7.jpg') }}" rel="gallery" class="fancybox img-hover-v2" title="Image 9">
                                <span><img class="img-responsive" src="{{ asset('/assets/img/main/img7.jpg') }}" alt=""></span>
                            </a>
                        </li>
                    </ul>
                    <!-- End Photostream -->
                        ...
                        <div class="carousel slide carousel-v2" id="portfolio-carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="item active">
                                    <img class="img-responsive full-width" src="{{ asset('/assets/img/main/img16.jpg') }}" alt="">
                                </div>
                                <div class="item">
                                    <img class="img-responsive full-width" src="{{ asset('/assets/img/main/img4.jpg') }}" alt="">
                                </div>
                                <div class="item">
                                    <img class="img-responsive full-width" src="{{ asset('/assets/img/main/img5.jpg') }}" alt="">
                                </div>
                            </div>
