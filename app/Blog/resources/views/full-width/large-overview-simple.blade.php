...
@section('content')
    <div class="container content blog-full-width">
        ...
        <div class="blog margin-bottom-40">
            <div class="blog-img">
                <img class="img-responsive" src="{{ asset('/assets/img/sliders/4.jpg') }}" alt="">
            </div>
            <h2>
                ...
                <div class="carousel slide carousel-v1" id="myCarousel">
                    <div class="carousel-inner">
                        <div class="item active">
                            <img alt="" src="{{ asset('/assets/img/sliders/10.jpg') }}">
                        ...
                        <div class="item">
                            <img alt="" src="{{ asset('/assets/img/sliders/11.jpg') }}">
                        ...
                        <div class="item">
                            <img alt="" src="{{ asset('/assets/img/sliders/2.jpg') }}">
